...
const DATA: any = {
  ...
  'znamka-plemena': { name: 'Psí známka - Výběr plemene', category: 'Psí známky', price: 300, images: ['/images/obojek_znamka.jpeg', '/images/Psi_znamka.png'], variants: ['Bernský honič', 'Český fousek'], type: 'select', map: { 'Bernský honič': 1, 'Český fousek': 0 } },
