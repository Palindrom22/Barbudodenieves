...
const DATA: any = {
  ...
  'znamka-plemena': { name: 'Psí známka - Výběr plemene', category: 'Psí známky', price: 300, images: ['/images/obojek_znamka.webp', '/images/Psi_znamka.png'], variants: ['Český fousek', 'Bernský honič'], type: 'select', map: { 'Bernský honič': 1, 'Český fousek': 0 } },
